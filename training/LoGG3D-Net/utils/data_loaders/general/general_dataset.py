...
class GeneralDataset(PointCloudDataset):
    ...
    def __init__(self,
        ...
        logging.info("Initializing GeneralDataset")
        for pickle_path in self.train_pickles:
            logging.info(f"Loading the pickles for {self.dataset} from {pickle_path}")
    ...
    def __init__(self,
        ...
        for pickle_path in self.train_pickles:
            ...
            for tuple_id in range(len(tuple_set)):
                ...
                tuple = GeneralTrainingTuple(dataset = self.dataset, training_tuple=train_tuple, id_offset=id_offset)
                self.files.append(tuple)
