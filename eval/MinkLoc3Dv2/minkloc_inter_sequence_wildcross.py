...
import minkloc_utils

def model_factory(config, model_config):
    params = minkloc_utils.load_params(config, model_config)
    return params, minkloc_utils.load_model(params)
...
class Evaluator:
    ...
    def get_latent_vectors(self, env_data, seq_name, params, debug):
        ...
        if os.path.exists(vectors_save_path):
            ...
            vectors = minkloc_utils.get_latent_vectors(self.model, env_data, params)
